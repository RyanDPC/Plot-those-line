...
namespace ActionMarque.OpenAPIs.AlphaVantage
{
    ...
    public partial class Client 
    {
        ...
        public virtual System.Threading.Tasks.Task<object> QueryAsync(string function, string symbol, string apikey)
        {
            return QueryAsync(function, symbol, apikey, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successful response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<object> QueryAsync(string function, string symbol, string apikey, System.Threading.CancellationToken cancellationToken)
        {
            if (function == null)
            ...
            urlBuilder_.Append(System.Uri.EscapeDataString("function") + "=").Append(System.Uri.EscapeDataString(ConvertToString(function, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
